...
public class App {
    ...
    public static void main(String[] args) throws IOException, ClientException, URISyntaxException, InterruptedException {
        // 读取配置文件
        ConfigurationManager.loadPropertiesFromResources("Z.properties");  // 1
        System.err.println(ConfigurationManager.getConfigInstance().getProperty("Z-client.ribbon.listOfServers"));

        // 构建一个HttpClient，serverList固定的情况
        RestClient client = (RestClient) ClientFactory.getNamedClient("Z-client");  // 2
        ...
        ConfigurationManager.getConfigInstance().setProperty(
                "Z-client.ribbon.listOfServers", "www.qq.com:80,www.taobao.com:80"); // 5
